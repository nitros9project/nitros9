...
* Interrupt trim (2026-09-07): no mask.  The server does not mind a gap between the bytes it
* receives, and the link is ours (DW$Settle) so nothing else writes the UART meanwhile.
