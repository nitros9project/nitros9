...
*
* R Taylor goal: detect RAM or Flash cartridge, force minimum sector
*  size to 4k or 8k for Flash, regardless of the /c0 descriptor.
*
* $Id$
*
...
* ------------------------------------------------------------------
*
*          2025/05/06  Roger Taylor
* Cart Flash programming code copied over from my Diag software.
*
