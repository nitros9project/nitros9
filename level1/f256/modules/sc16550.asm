...
* Fixed a number of issues in the driver and verified it works on the F256.
...
DTRFlow equ %00000001 DSR/DTR hardware flow control
...
cont4@ bita #MSR_DSR is DSR bit set?
 ...
 orb #DTRFlow else add that bit flag
...
cont3@ ldb <TxFloCtl get status flags
 ...
 bra ex@ exit
cont4@ bita #DTRFlow is this bit set?
...
cont@ tst <txBufCnt check tx buffer size
 ...
 andb #RTSFlow+DTRFlow+TxSwFlow
 andb <ITPARCopy
 bne cont2@
 ldb <txBufPos+1 get lower 8 bits of end pointer
