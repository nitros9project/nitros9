********************************************************************
* SHDW - Sierra AGI screen rendering module (Wildbits port)
*
* Derived from objs_lsl/shdw.asm (CoCo 3 original, documented by
* Paul W. Zibaila).
*
* Wildbits change: L0074 MMU bank switching removed.  On Wildbits
* Level 2 the process data area is one contiguous virtual space so
* DBlk8K ($0043) is a valid direct pointer — no $FFA9 writes needed.
*
*        Header for : shdw
...
* Wildbits: process data area is one contiguous virtual space;
* no MMU block switching needed.  DBlk8K ($0043) is a valid
* virtual pointer into the data area at $2000.
L0074               cmpa      MMUData
                    beq       L008e
                    sta       MMUData
                    ldu       DBlk8K
