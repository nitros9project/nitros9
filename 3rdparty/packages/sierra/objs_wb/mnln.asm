********************************************************************
* MNLN - Sierra AGI main line module (Wildbits port)
*
* Derived from objs_lsl/mnln.asm (CoCo 3 original).
*
* Wildbits changes:
*   L280B  - removed CoCo3 GIME $FFA9 bank-switching; $0043 is a
*            valid virtual pointer on Wildbits Level 2.
*   L2DED  - removed GIME $FFA9/$FFAB writes; kept $04,x data write.
