...
*
*        Header for : mnln
*        Module size: $6362  #25442
*        Module CRC : $1E6179 (Good)
*        Hdr parity : $29
*        Exec. off  : $0012  #18
*        Data size  : $0000  #0
*        Edition    : $00  #0
...
*
* Note: source rebased on lsl binary (2026-05-15). Data area uses kq3
*       meaningful names; code labels beyond $01B0 retain lsl hex labels.
*
...
ModuleInit               leas      -6,s                make room on the stack
...
GameLoop               clra
                    ...
                    std       ,s
InterpCycleTop               lbsr      L130A
SpeedWaitLoop               ldd       <$003E
                    cmpd      ,s
L00D2               bcc       CycleDoneNext
                    cmpd      $04,s
                    beq       SpeedWaitLoop
                    std       $04,s
                    bra       InterpCycleTop
CycleDoneNext               ldd       #$0000
                    std       <$003E
...
L00EA               sta       >$01AE
                    ...
                    sta       <$21,x
                    bra       AfterEgoCtrl
SaveEgoLoop               lda       <$21,x
                    sta       >$0437
AfterEgoCtrl               lbsr      L0750
                    lda       >$01AF
                    anda      #$40
                    sta       $03,s
                    lbsr      L5130
ExecCmdLoop               lda       >$0434
L011D               sta       $02,s
                    clrb
                    lbsr      L266C
                    leay      ,y
...
CmdQuitImpl               lda       ,y+
                    cmpa      #$01
                    beq       QuitConfirmed               if arg was a 1 then quit
                    leau      >L0082,pcr          get addr of quit / continue msg
                    lbsr      L3AA7               pass it to message_box()
                    beq       QuitRet               if we didn't get a 1 continue play
...
cmd_table
CmdTableStart               fdb       L5A16,$0000         *do nothing
