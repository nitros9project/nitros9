...
L02D5               tst       -1,u                Was hi bit set on matching char? (We hit end of function name?)
                    ...
                    leay      d,y                 Add offset
                    puls      x,u                 Get original 1st parm ptr & eat temp
...
L04CF               lda       #$4F                Fill code
                    cmpb      #1                  1 parameter?
                    beq       L04E8               Yes, just append Fill code & write buffer out
                    ...
                    bra       L04E8               Append fill code & write it out
