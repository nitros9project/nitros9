********************************************************************
* wild - Wildbits Basic09 subroutine module
*
...
* Created.
*   2      2024/11/02  Matt Massie - Added Graphics, Mouse, Joystick functions
*
...
;;; Calling syntax: RUN WILD([path,] "Peekw", address,return_value)
...
;;; Calling syntax: RUN WILD([path,] "Pokew", address,value)
...
;;;
;;; Calling syntax: RUN WILD([path,] "TONE", frequency, duration, volume)
...
;;;
;;; Calling syntax: RUN WILD([path,] "CURON")
